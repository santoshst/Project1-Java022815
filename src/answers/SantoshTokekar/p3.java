	...
	public static ArrayList<Integer> readFile(){
	   ...
	   String  thisLine = null;
			      try{
			         ...
			         BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Instructors\\workspace\\TestProject\\src\\Weekly\\benford_file1.txt"));
			         while ((thisLine = br.readLine()) != null) {
			            //System.out.println(thisLine);
			        	 arrayList.add(Integer.parseInt(thisLine));
			         }       
			      }catch(Exception e){
			         e.printStackTrace();
			      }
	   ...
	   public static void main(String[] args){
	        ...
	        int[]counter = countDigits((ArrayList<Integer>) arr);     
		   evaluate(counter);
	    }
	    ...
	    public static void evaluate(int[] counter){
	        ...
	        System.out.println("No of Occurences  Number Percentage");
